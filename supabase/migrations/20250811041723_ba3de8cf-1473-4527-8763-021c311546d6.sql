-- Reservations schema: room types and rooms
...
-- Policies: everyone authenticated can read; admins or front office can manage
CREATE POLICY IF NOT EXISTS "Authenticated can view room_types"
ON public.room_types
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY IF NOT EXISTS "Admins and front office can manage room_types"
ON public.room_types
FOR ALL
TO authenticated
USING (
...
-- Policies: everyone authenticated can read; admins or front office can manage
CREATE POLICY IF NOT EXISTS "Authenticated can view rooms"
ON public.rooms
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY IF NOT EXISTS "Admins and front office can manage rooms"
ON public.rooms
FOR ALL
TO authenticated
USING (
